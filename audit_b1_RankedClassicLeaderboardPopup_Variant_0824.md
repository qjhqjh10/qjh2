# UI 规格审计: RankedClassicLeaderboardPopup Variant
...
```
RankedClassicLeaderboardPopup Variant [godot(x-0.0 y0.0 w1920.0 h1080.0)]
...
| 元素 | 命中 |
|---|---|
| RankedClassicLeaderboardPopup Variant | ✅ `scripts\leaderboard_popup.gd:4 ## RankedClassicLeaderboardPopup Variant [13826] / DraftLeaderboardPopup [7182] 说明书 (深读 2026-08-23)` |
...
| BackgroundHighlight | ✅ `scripts\draft_leaderboard_popup.gd:264 # 行背景 (原版 Background color(0.83,0.19,0.43,0.16) + 自排名行 BackgroundHighlight; scripts\rank_ro` |
...
| border | ✅ `scripts\ally_badge_drawer.gd:141 fsb.border_color = Color(0.969, 0.914, 0.714); scripts\ally_badge_drawer.gd:142 fsb.set_border_wi` |
| Icon | ✅ `scripts\achievements.gd:230 # 奖励行 (原版 rewards '2 points' 白 @(402.7,102) + rewardIcon seal @(374.1,97.2)); scripts\ally_badge_drawe` |
| Name Holder | ✅ `scripts\draft_leaderboard_popup.gd:315 # 玩家名 (原版 Name Holder (290,0) 734x100 40px 白); scripts\rank_row.gd:16 ##   Name Holder (290` |
...
| Guild Name | ✅ `scripts\rank_row.gd:16 ##   Name Holder (290,0) 734×100 → Name 40px 白 + Guild Name 30px 白; scripts\rank_row.gd:111 # 玩家名 (原版 Name ` |
| RankingIcon | ✅ `scripts\draft_leaderboard_popup.gd:327 # 骷髅印章 (原版 RankingIcon 槽位 (990,4.1) 60x91.8; Rank Skull 印章资源); scripts\rank_row.gd:5 ##   P` |
| Points | ✅ `scripts\ally_badge_drawer.gd:165 # HLG pad 25/spacing10: Quantity 75pt 右(原版 inactive) + Name 'Campaign Points' 75pt 居中); scripts\b` |
