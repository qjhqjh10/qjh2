...
def main() -> int:
    ...
    WANT = {
        'battlearena2': ['Banner1', 'Skull_Left1', 'Skull_Right1', 'Tower_Silk_11', 'Rubble1',
                         'Barrels1', 'Container11', 'Steam pipes', 'Skull_Left.001', 'Rope1'],
        'battlearena3': ['Monolith Front Left1', 'Monolith Front Right1', 'Broken Monolith 11',
                         'Ground Lights1', 'Props 1.0011', 'Big Monolith', 'Dynamic Monolith', 'Structures', 'Ground Lights.001'],
        'battlearenaaeldari': ['Banner 1', 'Banner 2', 'Tower 1', 'Bridge 1', 'Platform 1',
                               'Tower 2', 'Tower 3', 'Tower 4', 'Bridge 2', 'Platform Back', 'Props', 'Battleground'],
        'battlearenaastramilitarum': ['Banner 1', 'Banner 4', 'Statue 1', 'Barricade 1', 'Bunker Antenna 1',
                                      'Crates', 'Barrels1', 'Chimera1', 'Tank', 'Tarantula', 'Crane', 'BunkerSandbags', 'Generator', 'Valkyrie'],
        'battlearenadarkangels': ['Turret 1 Banner', 'Skull vent 1', 'Generator', 'Container 1',
                                  'Ship', 'Barrels1', 'Crates', 'Vent 1', 'Tower 1', 'Foreground Statue1', 'Pipes', 'Dock'],
        'battlearenaemperorschildren': ['Curtain 1', 'Cauldron 1', 'Cauldron 2', 'Glass Tube 1', 'Spike 1',
                                        'Hook', 'Chain', 'Crate', 'Gun', 'Ornament', 'Throne1', 'Trophy Rack', 'Weapon Rack', 'Machinery'],
        'battlearenagenestealers': ['Banner 3', 'Genestaler Fan', 'Machinery Center', 'Hanging Hook',
                                    'Crates Left', 'Chain', 'Generator Left', 'Vehicle', 'Cranes Left', 'Barrels1', 'Crate Right'],
        'battlearenaleviathan': ['Thorn_5', 'Capillary_1', 'Prop_front_1', 'Floor Tentacle',
                                 'Thorn_1', 'Thorn_2', 'Thorn_3', 'Bunker', 'Prop_front_2', 'Prop_vehicle', 'Toxic_pool', 'Capillary_2'],
        'battlearenasororitas': ['Banner 1', 'Statue L', 'Statue R', 'Cauldron L', 'Candle 2',
                                 'Pillar', 'Side Altar', 'Altar Stairs', 'Hanging Cauldron', 'Candles', 'Rope', 'Altar Center'],
        'battlearenaspacewolves': ['Banner 1', 'Wolf Left', 'Wolf Right', 'Cauldron 1', 'Rock 1',
                                   'Keep', 'Container', 'Structure', 'Rock 2', 'Background Gun', 'Rock Midground'],
        'battlearenatauviorla': ['Plasma Generator', 'Drone 1', 'Railgun Tower', 'Bunker console',
                                 'Crashed flyer', 'Crashed tank', 'Console Front', 'Bunker 1', 'BG Building', 'Bunker 2'],
    }
    for arena in ARENAS:
