# UI 规格审计: WelcomeScreen Alpha

> 来源: d:/2/解包整理/03_界面UI/菜单 (原始 Unity JSON; 坐标=chain_rect.py v2 算法权威换算) — 生成 2026-08-24 21:40
> 项目: d:/warpforge ; 未命中⚠️元素 = 需人工判断 (动态生成/命名不同/确实缺失)

## 规格表 (说明书期望)

```
WelcomeScreen Alpha [godot(x0.0 y0.0 w1920.0 h1080.0)]
...
| Tap To continue | ✅ `scripts\season_banner_popup.gd:32 const TAP_CONTINUE := "Click to continue"                            # Tap To continue 40/50pt (` |
