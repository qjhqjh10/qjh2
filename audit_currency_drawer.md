# UI 规格审计: Currency Drawer

> 来源: d:/2/解包整理/03_界面UI/菜单 (原始 Unity JSON; 坐标=chain_rect.py v2 算法权威换算) — 生成 2026-08-23 18:31
> 项目: d:/warpforge ; 未命中⚠️元素 = 需人工判断 (动态生成/命名不同/确实缺失)

## 规格表 (说明书期望)

```
Currency Drawer [godot(x0.0 y0.0 w1920.0 h1080.0)]
  Content [godot(x960.0 y540.0 w0.0 h0.0)]
    ...
    Label [godot(x960.0 y540.0 w0.0 h0.0)]
      ...
      Quantity [txt=500 godot(x960.0 y540.0 w0.0 h0.0)]
