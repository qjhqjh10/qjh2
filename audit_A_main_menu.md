...
```
MainMenu [godot(x0.0 y0.0 w1920.0 h1080.0)]
  MainMenu [godot(x0.0 y0.0 w1920.0 h1080.0)]
    Background [godot(x0.0 y0.0 w1920.0 h1080.0)]
    Safe area All [godot(x0.0 y0.0 w1920.0 h1080.0)]
      GameModes [godot(x167.0 y71.3 w1753.0 h1008.7)]
        Viewport [godot(x167.0 y71.3 w1753.0 h1008.7)]
          Content [godot(x167.0 y134.4 w74.0 h945.6)]
  Safe area Only Horizontal [godot(x0.0 y0.0 w1920.0 h1080.0)]
    Navigation Panel [godot(x0.0 y0.0 w191.0 h1080.0)]
      Background [godot(x-164.4 y0.1 w329.5 h1145.7)]
      Panel Shadow [godot(x-762.5 y511.7 w1928.7 h70.0)]
      Separators Left [godot(x-2.5 y71.0 w2.8 h1009.0)]
      Separators Right [godot(x164.0 y71.0 w2.8 h1009.0)]
      Buttons Container [godot(x-0.3 y148.4 w164.3 h931.7)]
        Main Menu Navigation Button - Home [godot(x-82.5 y995.2 w164.3 h169.7)]
          Selected highlight [godot(x-82.5 y995.2 w164.3 h169.7)]
          Image [godot(x-77.6 y998.2 w156.4 h137.4)]
          Text Background [godot(x-72.9 y1113.5 w147.0 h39.4)]
            Text (TMP) [txt=PLAY godot(x-72.9 y1113.5 w147.0 h39.4)]
          Badge Highlight [godot(x35.6 y1086.9 w35.0 h35.0)]
            OneText [godot(x35.6 y1087.9 w35.0 h35.0)]
        Main Menu Navigation Button - Collection [godot(x-82.5 y995.2 w164.3 h169.7)]
          Selected highlight [godot(x-82.5 y995.2 w164.3 h169.7)]
          Image [godot(x-69.4 y996.9 w140.0 h140.0)]
          Text Background [godot(x-72.9 y1113.5 w147.0 h39.4)]
            Text (TMP) [txt=COLLECTION godot(x-72.9 y1113.5 w147.0 h39.4)]
          Badge Highlight [godot(x35.6 y1086.9 w35.0 h35.0)]
            OneText [godot(x35.6 y1087.9 w35.0 h35.0)]
        Main Menu Navigation Button - Shop [godot(x-82.5 y995.2 w164.3 h169.7)]
          Selected highlight [godot(x-82.5 y995.2 w164.3 h169.7)]
          Image [godot(x-69.4 y996.9 w140.0 h140.0)]
          Text Background [godot(x-72.9 y1113.5 w147.0 h39.4)]
            Text (TMP) [txt=SHOP godot(x-72.9 y1113.5 w147.0 h39.4)]
          Badge Highlight [godot(x35.6 y1086.9 w35.0 h35.0)]
            OneText [godot(x35.6 y1087.9 w35.0 h35.0)]
        Main Menu Navigation Button - Rewards [godot(x-82.5 y995.2 w164.3 h169.7)]
          Selected highlight [godot(x-82.5 y995.2 w164.3 h169.7)]
          Image [godot(x-69.4 y996.9 w140.0 h140.0)]
          Text Background [godot(x-72.9 y1113.5 w147.0 h39.4)]
            Text (TMP) [txt=REWARDS godot(x-72.9 y1113.5 w147.0 h39.4)]
          Badge Highlight [godot(x35.6 y1086.9 w35.0 h35.0)]
            OneText [godot(x35.6 y1087.9 w35.0 h35.0)]
        Main Menu Navigation Button - Social [godot(x-82.5 y995.2 w164.3 h169.7)]
          Selected highlight [godot(x-82.5 y995.2 w164.3 h169.7)]
          Image [godot(x-69.4 y996.9 w140.0 h140.0)]
          Text Background [godot(x-72.9 y1113.5 w147.0 h39.4)]
            Text (TMP) [txt=SOCIAL godot(x-72.9 y1113.5 w147.0 h39.4)]
          Badge Highlight [godot(x35.6 y1086.9 w35.0 h35.0)]
            OneText [godot(x35.6 y1087.9 w35.0 h35.0)]
    ChatPreview [godot(x1475.0 y85.0 w400.0 h60.0)]
      Container [godot(x1474.7 y85.0 w372.3 h60.0)]
        Message Preview [godot(x1474.7 y145.0 w0.0 h0.0)]
          text [txt=<color=#00FF20>Player Name:</color> Mess godot(x1474.7 y145.0 w-30.0 h0.0)]
        Message Preview (1) [godot(x1474.7 y145.0 w0.0 h0.0)]
          Sparks (2)
      Button [godot(x1811.0 y81.8 w68.0 h66.5)]
    1 - Below Upper Bar Holder [godot(x0.0 y0.0 w1920.0 h1080.0)]
    Upper bar [godot(x0.0 y0.0 w1920.0 h100.0)]
      Background [godot(x-11.7 y0.0 w1931.7 h71.3)]
      SettingsBtn [godot(x1803.1 y4.6 w87.8 h61.8)]
        Badge Highlight [godot(x1865.9 y4.4 w25.0 h25.0)]
          OneText [godot(x1860.9 y0.3 w35.0 h35.0)]
      TopBarButtons [godot(x425.3 y-0.2 w311.4 h71.4)]
        InboxBtn [godot(x397.8 y71.2 w55.0 h40.0)]
          Badge Highlight [godot(x426.8 y57.7 w35.0 h35.0)]
            OneText [godot(x426.8 y58.6 w35.0 h35.0)]
        Challenge button [godot(x401.6 y71.2 w47.4 h47.4)]
          Badge Highlight [godot(x426.8 y61.4 w35.0 h35.0)]
        Feedback Button [inactive godot(x565.4 y10.5 w50.0 h50.0)]
      Player Profile [godot(x0.0 y0.0 w528.7 h211.1)]
        Background [godot(x23.0 y11.6 w388.0 h124.0)]
        Background Mask [inactive godot(x25.6 y14.9 w446.5 h45.6)]
          Planer Name Background [godot(x25.6 y14.9 w446.5 h45.6)]
        Player Name [txt=Player Name godot(x136.9 y13.7 w265.0 h48.0)]
        Profile border [inactive godot(x23.0 y13.3 w109.5 h122.3)]
          Profile content [inactive godot(x-18.9 y-34.6 w198.0 h195.1)]
        Avatar Item Small [godot(x11.1 y9.0 w138.5 h139.5)]
          Raycast Target [godot(x-9.1 y-37.6 w178.9 h214.4)]
          Image Container [godot(x11.1 y9.0 w138.5 h102.2)]
            Highlight [inactive godot(x-52.6 y-41.4 w269.3 h197.7)]
            Border [godot(x-10.0 y9.0 w175.5 h130.0)]
            Image [godot(x-58.1 y-44.8 w276.9 h204.4)]
          Avatar Name [inactive txt=Avatar name godot(x11.1 y148.5 w138.5 h41.3)]
        Icon
      Resources Bar [godot(x1131.5 y-0.1 w671.0 h71.2)]
        Resources Container [godot(x1802.5 y-0.1 w0.0 h71.2)]
    Borders [inactive godot(x0.0 y0.0 w1920.0 h1080.0)]
      Side Border Left [godot(x-933.0 y-580.8 w934.0 h2280.4)]
      Side Border Right [godot(x1919.0 y-600.2 w934.0 h2280.4)]
    2 - Canvas Holder Above upper bar [godot(x0.0 y0.0 w1920.0 h1080.0)]
    3 - PopUp Holder [godot(x0.0 y0.0 w1920.0 h1080.0)]
    ...
    LoadingMenu [inactive godot(x0.0 y0.0 w1920.0 h1080.0)]
      Panel [godot(x-6003.2 y-5033.6 w13926.4 h11141.2)]
    UI Error Message Controller (MUST BE ENABLED) [inactive godot(x-0.4 y0.0 w1920.7 h336.6)]
      Container [godot(x-0.4 y70.4 w1920.7 h266.2)]
        Error Mensage_Ref [godot(x305.0 y286.6 w1310.0 h50.0)]
          Background [godot(x650.7 y292.6 w618.6 h38.1)]
            ErrorMesage Text [txt=ERROR MESSAGE CONTENT godot(x770.7 y296.6 w378.6 h34.1)]
    TooltipManager [godot(x-50.4 y515.0 w100.0 h100.0)]
    Toast Notification Controller [godot(x0.0 y0.0 w1920.0 h1080.0)]
      Holder [godot(x1264.1 y327.4 w634.5 h752.6)]
    Loading Controller [godot(x-419.0 y145.0 w1920.0 h1080.0)]
      Holder [godot(x-419.0 y145.0 w1920.0 h1080.0)]
        Menu Dark Background [inactive godot(x-1848.3 y-550.2 w4574.6 h2572.4)]
          Animated Loading Image [godot(x303.8 y600.8 w270.4 h270.4)]
            Cog [godot(x303.8 y600.8 w270.4 h270.4)]
```
...
| 元素 | 命中 |
|---|---|
| MainMenu | ✅ `scripts\main_menu.gd:5 ##   ② MainMenu: Background(全屏暗红渐变)+ Safe area All(GameModes 模式卡区); scripts\main_menu.gd:167 ## (渐变 = MainM` |
| MainMenu | ✅ `scripts\main_menu.gd:5 ##   ② MainMenu: Background(全屏暗红渐变)+ Safe area All(GameModes 模式卡区); scripts\main_menu.gd:167 ## (渐变 = MainM` |
...
| Safe area All | ✅ `scripts\main_menu.gd:5 ##   ② MainMenu: Background(全屏暗红渐变)+ Safe area All(GameModes 模式卡区)` |
| GameModes | ✅ `scripts\main_menu.gd:5 ##   ② MainMenu: Background(全屏暗红渐变)+ Safe area All(GameModes 模式卡区); scripts\main_menu.gd:62 # --- 模式卡区 (Gam` |
...
| Safe area Only Horizontal | ✅ `scripts\main_menu.gd:6 ##   ③ Safe area Only Horizontal: Navigation Panel / ChatPreview / Upper bar(顶栏)/ 3 个 Holder / 弹窗层; scripts` |
| Navigation Panel | ✅ `scripts\main_menu.gd:6 ##   ③ Safe area Only Horizontal: Navigation Panel / ChatPreview / Upper bar(顶栏)/ 3 个 Holder / 弹窗层; scripts` |
| Background | ✅ `scripts\achievements.gd:110 # 背景 (原版 Menu Dark Background + Fake Background 晕影 + Noise); scripts\achievements.gd:110 # 背景 (原版 Menu` |
| Panel Shadow | ✅ `scripts\main_menu.gd:59 const NAV_SHADOW := "res://assets/ui/mainmenu/scenes_sprites/Smooth background lateral.png"  # Panel; scri` |
| Separators Left | ✅ `scripts\main_menu.gd:230 ##   Separators Left/Right(40k_Separator 2.8 宽, x[-2.5,0.3]&x[164,166.8] y[-0.1,1009]); scripts\main_menu` |
| Separators Right | ⚠️ 未命中 |
| Buttons Container | ✅ `scripts\main_menu.gd:231 ##   Buttons Container(5 键: VerticalLayoutGroup spacing-16.35 padding top-5 → 步进 153.35, 键1 顶 y=-5); scri` |
| Main Menu Navigation Button - Home | ⚠️ 未命中 |
| Selected highlight | ✅ `scripts\main_menu.gd:232 ##   键内: [Selected highlight 红底 164.3x169.7] + [图标: Home 156.3x137.4 / 其他 140² 中心(83.1,71.7)]; scripts\ma` |
...
| Text Background | ✅ `scripts\main_menu.gd:233 ##         + [Text Background nametag 146.9x39.4 中心(0.9,53.1)] + [Badge 35² 右上(-11.2,-91.7)]; scripts\mai` |
| Text (TMP) | ⚠️ 未命中 |
...
| OneText | ⚠️ 未命中 |
| Main Menu Navigation Button - Collection | ⚠️ 未命中 |
| Selected highlight | ✅ `scripts\main_menu.gd:232 ##   键内: [Selected highlight 红底 164.3x169.7] + [图标: Home 156.3x137.4 / 其他 140² 中心(83.1,71.7)]; scripts\ma` |
| Image | ✅ `scripts\achievements.gd:186 ## 成就容器 (原版 Achievement Container 520x150: Image 130 + 标题/描述 + 进度条 + 奖励); scripts\achievements.gd:205 ` |
| Text Background | ✅ `scripts\main_menu.gd:233 ##         + [Text Background nametag 146.9x39.4 中心(0.9,53.1)] + [Badge 35² 右上(-11.2,-91.7)]; scripts\mai` |
| Text (TMP) | ⚠️ 未命中 |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| OneText | ⚠️ 未命中 |
| Main Menu Navigation Button - Shop | ⚠️ 未命中 |
| Selected highlight | ✅ `scripts\main_menu.gd:232 ##   键内: [Selected highlight 红底 164.3x169.7] + [图标: Home 156.3x137.4 / 其他 140² 中心(83.1,71.7)]; scripts\ma` |
| Image | ✅ `scripts\achievements.gd:186 ## 成就容器 (原版 Achievement Container 520x150: Image 130 + 标题/描述 + 进度条 + 奖励); scripts\achievements.gd:205 ` |
| Text Background | ✅ `scripts\main_menu.gd:233 ##         + [Text Background nametag 146.9x39.4 中心(0.9,53.1)] + [Badge 35² 右上(-11.2,-91.7)]; scripts\mai` |
| Text (TMP) | ⚠️ 未命中 |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| OneText | ⚠️ 未命中 |
| Main Menu Navigation Button - Rewards | ⚠️ 未命中 |
| Selected highlight | ✅ `scripts\main_menu.gd:232 ##   键内: [Selected highlight 红底 164.3x169.7] + [图标: Home 156.3x137.4 / 其他 140² 中心(83.1,71.7)]; scripts\ma` |
| Image | ✅ `scripts\achievements.gd:186 ## 成就容器 (原版 Achievement Container 520x150: Image 130 + 标题/描述 + 进度条 + 奖励); scripts\achievements.gd:205 ` |
| Text Background | ✅ `scripts\main_menu.gd:233 ##         + [Text Background nametag 146.9x39.4 中心(0.9,53.1)] + [Badge 35² 右上(-11.2,-91.7)]; scripts\mai` |
| Text (TMP) | ⚠️ 未命中 |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| OneText | ⚠️ 未命中 |
| Main Menu Navigation Button - Social | ⚠️ 未命中 |
| Selected highlight | ✅ `scripts\main_menu.gd:232 ##   键内: [Selected highlight 红底 164.3x169.7] + [图标: Home 156.3x137.4 / 其他 140² 中心(83.1,71.7)]; scripts\ma` |
| Image | ✅ `scripts\achievements.gd:186 ## 成就容器 (原版 Achievement Container 520x150: Image 130 + 标题/描述 + 进度条 + 奖励); scripts\achievements.gd:205 ` |
| Text Background | ✅ `scripts\main_menu.gd:233 ##         + [Text Background nametag 146.9x39.4 中心(0.9,53.1)] + [Badge 35² 右上(-11.2,-91.7)]; scripts\mai` |
| Text (TMP) | ⚠️ 未命中 |
...
| 1 - Below Upper Bar Holder | ⚠️ 未命中 |
| Upper bar | ✅ `scripts\main_menu.gd:6 ##   ③ Safe area Only Horizontal: Navigation Panel / ChatPreview / Upper bar(顶栏)/ 3 个 Holder / 弹窗层; scripts` |
| Background | ✅ `scripts\achievements.gd:110 # 背景 (原版 Menu Dark Background + Fake Background 晕影 + Noise); scripts\achievements.gd:110 # 背景 (原版 Menu` |
| SettingsBtn | ✅ `scripts\battle.gd:2042 # ===== Settings按钮 (SettingsBtn 64² @ (1808,9) UI_Settings_Icon) =====; scripts\main_menu.gd:24 const TOP_S` |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| OneText | ⚠️ 未命中 |
| TopBarButtons | ✅ `scripts\main_menu.gd:489 ##   TopBarButtons(HorizontalLayoutGroup spacing 9.75 MiddleLeft @x[425.3,736.7] y[-0.2,71.2]):; scripts\` |
| InboxBtn | ✅ `scripts\inbox.gd:6 ## 主菜单 InboxBtn (收件箱图标) → 打开本界面; scripts\main_menu.gd:22 const TOP_MAIL := "res://assets/ui/mainmenu/scenes_spr` |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| OneText | ⚠️ 未命中 |
| Challenge button | ✅ `scripts\main_menu.gd:23 const TOP_CHALLENGE := "res://assets/ui/mainmenu/scenes_sprites/40K_icon_duel.png"  # Challenge butt` |
| Badge Highlight | ✅ `scripts\collection.gd:285 # 角标 (原版 Badge Highlight 40K_notification_number 35x35 右上:; scripts\deck_collection.gd:293 # 角标 (原版 Badg` |
| Feedback Button | ✅ `scripts\main_menu.gd:25 const TOP_FEEDBACK := "res://assets/ui/mainmenu/scenes_sprites/40K_icon_feedback.png"  # Feedback Bu` |
| Player Profile | ✅ `scripts\main_menu.gd:18 const TOP_PLAYER_FRAME := "res://assets/ui/mainmenu/scenes_sprites/40k_main_player frame.png"  # Pla; scri` |
| Background | ✅ `scripts\achievements.gd:110 # 背景 (原版 Menu Dark Background + Fake Background 晕影 + Noise); scripts\achievements.gd:110 # 背景 (原版 Menu` |
| Background Mask | ⚠️ 未命中 |
| Planer Name Background | ✅ `scripts\main_menu.gd:19 const TOP_NAME_BG := "res://assets/ui/mainmenu/scenes_sprites/40k_topmarquee_currency_display BW.png` |
...
| Profile border | ✅ `scripts\main_menu.gd:20 const TOP_AVATAR_BORDER := "res://assets/ui/mainmenu/scenes_sprites/Player Profile Border.png"  # Pr` |
| Profile content | ⚠️ 未命中 |
...
| Resources Bar | ✅ `scripts\main_menu.gd:27 # 货币条 (Resources Bar x[1131.5,1802.5] y[0,71.2], Resources Container 右锚右对齐 → 内容右缘 1802.5-5 padding); scrip` |
| Resources Container | ✅ `scripts\main_menu.gd:27 # 货币条 (Resources Bar x[1131.5,1802.5] y[0,71.2], Resources Container 右锚右对齐 → 内容右缘 1802.5-5 padding); scrip` |
| Borders | ⚠️ 未命中 |
| Side Border Left | ⚠️ 未命中 |
| Side Border Right | ⚠️ 未命中 |
| 2 - Canvas Holder Above upper bar | ⚠️ 未命中 |
| 3 - PopUp Holder | ⚠️ 未命中 |
...
| LoadingMenu | ✅ `scripts\loading.gd:2 ## 加载界面 (原版 LoadingMenu 说明书: 暗背景 + 骷髅 + 齿轮旋转)` |
| Panel | ✅ `scripts\battle.gd:1242 # ---------- Cemetery (原版 ShowCemeteryBtn → CemeteryLogPanel) ----------; scripts\battle.gd:1247 ## Cemeter` |
| UI Error Message Controller (MUST BE ENABLED) | ⚠️ 未命中 |
| Container | ✅ `scripts\achievements.gd:2 ## 成就界面 (原版 Achievements Tab 说明书: 类型筛选按钮 + Achievement Container 520x150 网格); scripts\achievements.gd:41` |
| Error Mensage_Ref | ⚠️ 未命中 |
| Background | ✅ `scripts\achievements.gd:110 # 背景 (原版 Menu Dark Background + Fake Background 晕影 + Noise); scripts\achievements.gd:110 # 背景 (原版 Menu` |
| ErrorMesage Text | ⚠️ 未命中 |
| TooltipManager | ✅ `scripts\player_profile.gd:1246 TooltipManager.show_tooltip("Faction Rating", "Faction rating shows your ranking score earned with ` |
| Toast Notification Controller | ⚠️ 未命中 |
| Holder | ✅ `scripts\battle.gd:131 var _your_turn_img: TextureRect = null   # 玩家回合绿色提示 (原版 YourTurnImage 40k_DeckHolder_light_green); scripts\b` |
| Loading Controller | ✅ `scripts\loading.gd:3 ## 2026-08-18 重做: 按主菜单全树.md Loading Controller 结构 — Animated Loading Image 270x270` |
| Holder | ✅ `scripts\battle.gd:131 var _your_turn_img: TextureRect = null   # 玩家回合绿色提示 (原版 YourTurnImage 40k_DeckHolder_light_green); scripts\b` |
| Menu Dark Background | ✅ `scripts\achievements.gd:110 # 背景 (原版 Menu Dark Background + Fake Background 晕影 + Noise); scripts\campaign.gd:94 # 背景 (原版 Menu Dark` |
...
- `Separators Right`
- `Main Menu Navigation Button - Home`
- `Text (TMP)`
- `OneText`
- `Main Menu Navigation Button - Collection`
- `Text (TMP)`
- `OneText`
- `Main Menu Navigation Button - Shop`
- `Text (TMP)`
- `OneText`
- `Main Menu Navigation Button - Rewards`
- `Text (TMP)`
- `OneText`
- `Main Menu Navigation Button - Social`
- `Text (TMP)`
- `OneText`
- `Message Preview (1)`
- `Sparks (2)`
- `1 - Below Upper Bar Holder`
- `OneText`
- `OneText`
- `Background Mask`
- `Profile content`
...
- `Side Border Left`
- `Side Border Right`
- `2 - Canvas Holder Above upper bar`
- `3 - PopUp Holder`
- `Card Options Panel`
- `Crafting Panel`
- `Explanation`
...
- `UI Error Message Controller (MUST BE ENABLED)`
- `Error Mensage_Ref`
- `ErrorMesage Text`
